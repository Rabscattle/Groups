...
/**
 * This class represents the config.yml of a plugin. All sections of a yml are represented as a
 * ConfigBean and those are obligated to load from their corresponding section
 */
